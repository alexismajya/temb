...
describe('BaseInventoryComponent', function () {
    var component;
    var fixture;
    ...
    it('should test getInventory method', function () {
        jest.spyOn(component, 'loadData').mockImplementation();
        component.getInventory();
        expect(component.pageNo).toEqual(1);
        expect(component.isLoading).toEqual(false);
    });
    it('should test updateInventory method', function () {
        var providerInfo = { providerName: test, providerId: 1 };
        jest.spyOn(component, 'loadData').mockImplementation();
        component.updateInventory(providerInfo);
        expect(component.loadData).toHaveBeenCalled();
    });
    it('should test loadData method', function () {
    ...
    it('should test ShowOptions Method', function () {
        component.showOptions(-1);
        expect(component.currentOptions).toEqual(-1);
        component.showOptions(1);
        expect(component.currentOptions).toEqual(1);
    });
    it('should test emitData function', function () {
        var cabEmitter = new EventEmitter;
        var spy = jest.spyOn(EventEmitter.prototype, 'emit');
        component.emitData((cabEmitter));
        expect(spy).toHaveBeenCalled();
    });
});
//# sourceMappingURL=base-inventory.component.spec.js.map