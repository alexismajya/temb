...
describe('RouteRequestsComponent', function () {
    var component;
    var fixture;
    var httpMock;
    var service;
    ...
    beforeEach(inject([RouteRequestService, HttpTestingController, AuthService, AppEventService, MatDialog, AisService], function (_service, _httpMock, _authService, _appEventService, _matDialog, _aisService) {
        service = _service;
        httpMock = _httpMock;
    ...
    it('should create RouteRequestsComponent', function () {
    ...
    describe('Unit test', function () {
        ...
        it('should properly initialize component', function () {
            var routes = getAllResponseMock.routes;
            jest.spyOn(service, 'getAllRequests').mockReturnValue(of(routes));
            component.ngOnInit();
        ...
        it('should handle decline', function () {
            var route = getAllResponseMock.routes[0];
            component.onClickRouteBox(0, route);
            component.decline();
    ...
    it('Render Route Boxes: should render 3 route boxes with the first one active', function () {
        var request = httpMock.expectOne(service.routesUrl + "/requests");
        expect(request.request.method).toEqual('GET');
        request.flush(getAllResponseMock);
        fixture.detectChanges();
        var boxes = fixture.debugElement.queryAll(By.css('.route-box'));
    ...
    it('onClickRouteBox(): should call onCLickRouterBox', function () {
        var request = httpMock.expectOne(service.routesUrl + "/requests");
        expect(request.request.method).toEqual('GET');
        request.flush(getAllResponseMock);
        fixture.detectChanges();
...
//# sourceMappingURL=route-requests.component.spec.js.map