...
describe('ProviderCardComponent', function () {
    var component;
    var fixture;
    var injector;
    var appEventService;
    ...
    describe('Delete Provider', function () {
        ...
        it('should call provider service on delete', function () {
        ...
        it('should toast success and broadcast on delete provider success', function () {
        ...
        it('should toast error on delete provider fail', function () {
        ...
        it('should call delete provider on confirmation', function () {
            jest.spyOn(component, 'deleteProvider');
            var fixtureModal = TestBed.createComponent(ConfirmModalComponent);
            var modalComponent = fixtureModal.componentInstance;
            component.showDeleteModal();
            modalComponent.confirmDialog();
            expect(component.deleteProvider).toHaveBeenCalled();
        });
        it('should hide on options on close dialog', function () {
            jest.spyOn(component, 'deleteProvider');
            var fixtureModal = TestBed.createComponent(ConfirmModalComponent);
            var modalComponent = fixtureModal.componentInstance;
            component.showDeleteModal();
...
//# sourceMappingURL=provider-card.component.spec.js.map