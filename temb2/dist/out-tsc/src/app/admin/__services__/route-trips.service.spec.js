...
describe('RouteTripsService', function () {
    var injector;
    var service;
    var httpMock;
    var toastr;
    var serviceResponse = __assign({}, routeTripsResponseMock);
    beforeEach(function () {
    ...
    describe('service methods', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            it('should return route trips records', function (done) {
                service.getBatchTripsRecords({ page: 1, pageSize: 10 })
                    .subscribe(function (result) {
                    expect(result).toEqual(serviceResponse);
                    done();
                });
                var routeTripsUrl = environment.tembeaBackEndUrl + "/api/v2/trips/routetrips?page=1&size=10";
                var req = httpMock.expectOne(routeTripsUrl);
...
//# sourceMappingURL=route-trips.service.spec.js.map