...
describe('UserInventoryComponent', function () {
    var component;
    var fixture;
    var mockAlert = {
        success: jest.fn(),
    ...
    var mockMatDialog = {
        open: jest.fn().mockReturnValue({
            componentInstance: {
                executeFunction: {
                    subscribe: function () { return deleteUser(); }
                }
            },
    ...
    describe('deleteUser', function () {
        it('should delete user success response from http call', function () {
            var userSpy = jest.spyOn(component, 'getUsersData');
            var deleteSpy = jest.spyOn(mockUserService, 'deleteUser');
            component.getUsersData('');
            fixture.detectChanges();
        ...
        it('should display an error message if deleteUser is unsuccessful', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    it('should unsubscribe Subscriptions on ngOnDestroy', function () {
    ...
    describe('openEditUserModal', function () {
        it('should open edit modal when edit icon is clicked', function () {
...
//# sourceMappingURL=user-inventory.component.spec.js.map