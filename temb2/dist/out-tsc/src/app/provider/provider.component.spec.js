...
describe('ProviderComponent', function () {
    ...
    describe('onSubmit()', function () {
        it('should call tripRequestService.providerConfirm', function () {
        ...
        it('should call alert.error when validation error occured', function () {
            var error = {
        ...
        it('should throw an error if there is an internal server error', function () {
            var error = {
                error: { message: { error: 'Failed to complete trip confirmation, Please try again' } }
            };
            var result = new MockError(500, error.error.message.error);
