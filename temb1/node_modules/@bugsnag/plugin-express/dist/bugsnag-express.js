...
(function (root, factory) {
  ...
  } else if (typeof _$stackframe_8 === 'object') {
    _$stackframe_8 = factory();
  } else {
...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    _$errorStackParser_6 = factory(_$stackframe_8);
  } else {
...
(function (root, factory) {
  ...
  } else if (typeof _$stackGenerator_7 === 'object') {
    _$stackGenerator_7 = factory(_$stackframe_8);
  } else {
...
function ___extends_9() { ___extends_9 = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return ___extends_9.apply(this, arguments); }

/* removed: var _$errorStackParser_6 = require('error-stack-parser'); */;

/* removed: var _$stackGenerator_7 = require('stack-generator'); */;

/* removed: var _$hasStack_4 = require('./lib/has-stack'); */;

var __reduce_9 = _$esUtils_2.reduce,
    __filter_9 = _$esUtils_2.filter;
...
function () {
  ...
  _proto.updateMetaData = function updateMetaData(section) {
    ...
    this.metaData[section] = ___extends_9({}, this.metaData[section], updates);
    return this;
  };
...
BugsnagReport.getStacktrace = function (error, errorFramesToSkip, generatedFramesToSkip) {
  ...
  if (_$hasStack_4(error)) return _$errorStackParser_6.parse(error).slice(errorFramesToSkip); // error wasn't provided or didn't have a stacktrace so try to walk the callstack

  return __filter_9(_$stackGenerator_7.backtrace(), function (frame) {
...
var _$reportFromError_5 = function (maybeError, handledState) {
  var actualError = iserror(maybeError) ? maybeError : new Error('Handled a non-error. See "error" tab for more detail.');
  var report = new _$BugsnagReport_9(actualError.name, actualError.message, _$BugsnagReport_9.getStacktrace(actualError), handledState);
...
var _$requestInfo_11 = function (req) {
...
var _$express_10 = {};
function ___extends_10() { ___extends_10 = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return ___extends_10.apply(this, arguments); }

/* eslint node/no-deprecated-api: [error, {ignoreModuleItems: ["domain"]}] */
var domain = require("domain");

/* removed: var _$requestInfo_11 = require('./request-info'); */;

/* removed: var _$reportFromError_5 = require('@bugsnag/core/lib/report-from-error'); */;
...
_$express_10 = {
  ...
  init: function (client) {
    var requestHandler = function (req, res, next) {
      ...
      requestClient.metaData = ___extends_10({}, requestClient.metaData, {
        request: metaData
      });
      requestClient.request = request; // unhandled errors caused by this request

      dom.on('error', function (err) {
        req.bugsnag.notify(_$reportFromError_5(err, handledState), {}, function (e, report) {
    ...
    var errorHandler = function (err, req, res, next) {
      if (req.bugsnag) {
        req.bugsnag.notify(_$reportFromError_5(err, handledState));
      } else {
        ...
        client.notify(_$reportFromError_5(err, handledState, getRequestAndMetaDataFromReq(req)));
      }
...
var getRequestAndMetaDataFromReq = function (req) {
  var requestInfo = _$requestInfo_11(req);
  return {
...
_$express_10['default'] = _$express_10;
