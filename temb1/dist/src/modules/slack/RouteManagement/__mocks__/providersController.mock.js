...
exports.providersPayload = providersPayload;
let timeStamp;
let channelId;
...
exports.reassignDriverPayload = reassignDriverPayload;
const reassignCabPayload = {
    type: 'interactive_message',
    actions: [{ name: '1005', type: 'select', selected_options: [{ value: '1' }] }],
    ...
    original_message: {
        type: 'message',
        subtype: 'bot_message',
        text: 'Hi *Uber Kenya*, a vehicle of model *subaru* and a Registration Number: *SMI 319 JK* has been deleted by Andela Operations team.*',
        ts: '1562073459.000100',
        username: 'Tembea App',
        bot_id: 'BJQ1S9EP8',
    }
};
exports.reassignCabPayload = reassignCabPayload;
const route = {
    id: 1018,
    inUse: 2,
    takeOff: '03:00',
...
const completeOpsAssignCabPayload = Object.assign(Object.assign({ state }, providersPayload), { submission: {
        driver: 1,
        cab: 1,
        confirmationComment: 'comment',
    }, origin: { address: 'pickup' }, destination: { address: 'destination' }, rider: { name: 'passenger', phoneNo: 'phone' } });
exports.completeOpsAssignCabPayload = completeOpsAssignCabPayload;
//# sourceMappingURL=providersController.mock.js.map