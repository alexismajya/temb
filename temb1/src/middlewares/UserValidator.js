import {
  userUpdateSchema, newUserSchema, assignRoleSchema, getRoleSchema, newRoleSchema, deleteUserSchema
...
class UserValidator {
  ...
  static validateDeleteUser(req, res, next) {
    return GeneralValidator.joiValidation(req, res, next, req.params, deleteUserSchema);
  }
}
