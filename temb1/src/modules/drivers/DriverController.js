...
class DriverController {
  ...
  static async deleteDriver(req, res) {
    ...
    const routes = await routeBatchService
  ...
  static async update(req, res) {
    try {
      ...
      const driver = await driverService.driverUpdate(driverId, body);
      if (driver.message) {
  ...
  static async getDrivers(req, res) {
    try {
      ...
      const result = await driverService.getDrivers(pageable, where);
