...
export const payload = {
  ...
  response_url:
     'https://hooks.slack.com/actions/TPDKFR8TF/881407979378/5Qz4NpcHARHDFA0F3mTbExQs',
  ...
  view: { id: 'VS9R7AFGU',
    ...
    type: 'modal',
    private_metadata:
       '"https://hooks.slack.com/actions/TPDKFR8TF/884085122337/swdPpUnPeLaFUV905q73HuvM"',
...
export const unCompletePayload = {
  user: {
    id: 'UP0RTRL02',
  },
  actions:[{
